    ...
    <form action="add_questions">
    	 <div class="mainbox">
        	<div id = "typecontainer">
            	...
            	<textarea rows = "7" cols = "125"></textarea><br><br>
            	<div id= "MCQSection" style= "display: block">
            		...
            		<input type ="radio">&nbsp&nbsp<input type= "text" name="optionThree">
            		<input type ="radio">&nbsp&nbsp<input type= "text" name="optionFour"><br><br>
            		<input type ="radio">&nbsp&nbsp<input type= "text" name="optionFive">
            		<button onclick= "addingOption()">Add Option</button>
            </div>
			<div id="multipleAnswers" style = "display: none">
            	...
            	<center><button onclick= "addingOption()">Add Option</button></center>
			</div>
